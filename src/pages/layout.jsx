        ...
        <>
            <header>
                <div className="navigation-bar">
                    <div className="menu-wrap-container"><svg width="23" height="23" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="search-bar">
                        <form className="form">
                            ...
                            <input type="text" aria-label="search" placeholder="Search products, stores, and recipes" />
                        </form>
                    </div>
                    ...
                    <div className="login-buttons">
                        ...
                        <div className="shopping-cart">
                            <svg width="25" height="25" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" d="M1 2v2h2l3.6 7.59-1.35 2.44C4.52 15.37 5.48 17 7 17h12v-2H7l1.1-2h7.45c.75 0 1.41-.41 1.75-1.03l3.58-6.49A.996.996 0 0 0 20.01 4H5.21l-.94-2H1Zm6 16c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2Zm8.01 2c0-1.1.89-2 1.99-2s2 .9 2 2-.9 2-2 2-1.99-.9-1.99-2Z" clip-rule="evenodd"></path>
                            </svg>
